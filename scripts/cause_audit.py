...
VERDICTS = {
    ...
    "ConductiveLiquidIngress": (SHARED, "실무Ⅳ p.127 표 2-1 '액체물 적하'. 습기 노출의 하위라 누설·트래킹과 절연열화 사슬을 물려받는다 — 습기와 같은 판정"),
    "HermeticCompressorWindingSite": (SHARED, "권선 자리의 하위. 실무Ⅳ p.284 과부하 운전 → 절연열화 → 층간단락. 밀폐 여부는 자리를 좁히지 않고 결론의 조건(C-60 용기 밖 경로)만 더한다"),
