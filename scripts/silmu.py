...
CANDIDATES = [
    ...
    ("⑦", "통전 입증 단서", "칼날 광택·변색 경계, 칼날받이 열림, 필라멘트 앵커 용착",
     "p.178~179, p.214", "규칙이 아니라 제약. EnergizedState 는 이미 143/150 에서 확인으로 읽히고('사고 당시 통전됨') 6개 가설 전부 양립이라 "
     "지지 규칙은 공식상 0점이다. 필요한 것은 '결론에는 통전 확인이 있어야 한다'는 C- 도형(§9.9.1 필요조건). 칼날·삽입 표현 7건은 판독기가 이미 읽는다"),
]
