...
# 증거물 → 손상 양상(exhibits)은 점수에 쓰이지 않는다(lint 전용). 조사관에게 묻지 않는다.
sheet('4 현장사실', ['관계', '앞', '뒤', '문장으로 읽으면'], d4, [19, 22, 22, 52],
      '의견이 아니라 사건을 묻습니다. 사실은 확인됐는데 그 조건이 없었던 사건의 번호를 적어 주십시오.', extra_inputs=('반례 사건번호',))
